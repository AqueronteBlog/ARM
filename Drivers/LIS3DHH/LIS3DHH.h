...
typedef enum
{
    LIS3DHH_R0               =   0x00,           /*!<  R0  register          */
    LIS3DHH_R1               =   0x01,           /*!<  R1  register          */
    LIS3DHH_R2               =   0x02,           /*!<  R3  register          */
    LIS3DHH_R3               =   0x03,           /*!<  R4  register          */
    LIS3DHH_R4               =   0x04,           /*!<  R5  register          */
    LIS3DHH_R5               =   0x05,           /*!<  R6  register          */
    LIS3DHH_R6               =   0x06,           /*!<  R7  register          */
    LIS3DHH_R7               =   0x07,           /*!<  R8  register          */
    LIS3DHH_R8               =   0x08,           /*!<  R9  register          */
    LIS3DHH_R9               =   0x09,           /*!<  R10 register          */
    LIS3DHH_R10              =   0x0A,           /*!<  R11 register          */
    LIS3DHH_R11              =   0x0B,           /*!<  R11 register          */
    LIS3DHH_R12              =   0x0C,           /*!<  R12 register          */
    LIS3DHH_R13              =   0x0D,           /*!<  R13 register          */
    LIS3DHH_R14              =   0x0E,           /*!<  R14 register          */
    LIS3DHH_R15              =   0x0F,           /*!<  R15 register          */
    LIS3DHH_R16              =   0x10,           /*!<  R16 register          */
    LIS3DHH_R17              =   0x11,           /*!<  R17 register          */
    LIS3DHH_R18              =   0x12,           /*!<  R18 register          */
    LIS3DHH_R19              =   0x13            /*!<  R19 register          */
} LIS3DHH_spi_command_structure_registers_t;
...
} LIS3DHH_r2_s_wu1_20_150_khz_value_t;
...
} LIS3DHH_r2_s_wu1_15_20_khz_value_t;
...
} LIS3DHH_r14_rc_osc_taps_value_t;
...
} LIS3DHH_r16_clock_gen_dis_value_t;
...
} LIS3DHH_r16_lc_osc_dis_value_t;
...
} LIS3DHH_r16_rc_osc_min_value_t;
...
} LIS3DHH_r16_rc_osc_max_value_t;
...
} LIS3DHH_r16_lc_osc_mux3_value_t;
...
} LIS3DHH_r16_lc_osc_mux2_value_t;
...
} LIS3DHH_r16_lc_osc_mux1_value_t;
...
typedef enum
{
    LIS3DHH_CH1_OFF_CH2_OFF_CH3_OFF  =   0,              /*!<  All channels disabled                         */
    LIS3DHH_CH1_ON_CH2_OFF_CH3_OFF   =   1,              /*!<  Channels 1 enabled                            */
    LIS3DHH_CH1_OFF_CH2_ON_CH3_OFF   =   2,              /*!<  Channel 2 enabled                             */
    LIS3DHH_CH1_ON_CH2_ON_CH3_OFF    =   3,              /*!<  Channels 1 and 2 enabled                      */
    LIS3DHH_CH1_OFF_CH2_OFF_CH3_ON   =   4,              /*!<  Channel 3 enabled                             */
    LIS3DHH_CH1_ON_CH2_OFF_CH3_ON    =   5,              /*!<  Channels 1 and 3 enabled                      */
    LIS3DHH_CH1_OFF_CH2_ON_CH3_ON    =   6,              /*!<  Channels 2 and 3 enabled                      */
    LIS3DHH_CH1_ON_CH2_ON_CH3_ON     =   7               /*!<  All channels enabled                          */
} LIS3DHH_channels_enable_t;
...
typedef enum
{
    LIS3DHH_STANDARD_LISTENING_MODE  =   0,              /*!<  All channels are active at the same time      */
    LIS3DHH_SCANNING_MODE            =   1,              /*!<  Low Power mode 1                              */
    LIS3DHH_ON_OFF_MODE              =   2               /*!<  Low Power mode 2                              */
} LIS3DHH_scanning_mode_t;
...
typedef enum
{
    LIS3DHH_TOLERANCE_MASK       =   ( 0b11 << 0 ),      /*!<  Tolerance mask                            */
    LIS3DHH_TOLERANCE_TIGHT      =   ( 0b00 << 0 ),
    LIS3DHH_TOLERANCE_MEDIUM     =   ( 0b01 << 0 ),
    LIS3DHH_TOLERANCE_RELAX      =   ( 0b10 << 0 )
} LIS3DHH_tolerance_settings_t;
...
typedef enum
{
    LIS3DHH_CHANNEL_LF1P  =   0,                 /*!<  Channel 1         */
    LIS3DHH_CHANNEL_LF2P  =   1,                 /*!<  Channel 2         */
    LIS3DHH_CHANNEL_LF3P  =   2                  /*!<  Channel 3         */
} LIS3DHH_parallel_tuning_channels_t;
...
typedef enum
{
    LIS3DHH_CAPACITANCE_MASK       =   ( 0b11111 << 0 ),           /*!<  LIS3DHH_CAPACITANCE mask                 */
    LIS3DHH_CAPACITANCE_ADDS_NONE  =   ( 0b00000 << 0 ),           /*!<  None      to chosen channel             */
    LIS3DHH_CAPACITANCE_ADDS_1PF   =   ( 0b00001 << 0 ),           /*!<  Adds 1pF  to chosen channel             */
    LIS3DHH_CAPACITANCE_ADDS_2PF   =   ( 0b00010 << 0 ),           /*!<  Adds 2pF  to chosen channel             */
    LIS3DHH_CAPACITANCE_ADDS_4PF   =   ( 0b00100 << 0 ),           /*!<  Adds 4pF  to chosen channel             */
    LIS3DHH_CAPACITANCE_ADDS_8PF   =   ( 0b01000 << 0 ),           /*!<  Adds 8pF  to chosen channel             */
    LIS3DHH_CAPACITANCE_ADDS_16PF  =   ( 0b10000 << 0 )            /*!<  Adds 16pF to chosen channel             */
} LIS3DHH_parallel_tuning_capacitance_t;

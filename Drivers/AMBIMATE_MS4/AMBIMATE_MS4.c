...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_TriggerContinuousMeasurement ( I2C_parameters_t myI2Cparameters, uint16_t pressure_compensation )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_TRIGGERS_CONTINUOUS_MEASUREMENT >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_TRIGGERS_CONTINUOUS_MEASUREMENT & 0xFF );
  cmd[2]   =  (uint8_t)( pressure_compensation >> 8U );
  cmd[3]   =  (uint8_t)( pressure_compensation & 0xFF );
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( pressure_compensation );
...
/**
 * @brief       AMBIMATE_MS4_StopContinuousMeasurement    ( I2C_parameters_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_StopContinuousMeasurement.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_StopContinuousMeasurement ( I2C_parameters_t myI2Cparameters )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_STOP_CONTINUOUS_MEASUREMENT >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_STOP_CONTINUOUS_MEASUREMENT & 0xFF );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_SetMeasurementInterval    ( I2C_parameters_t , uint16_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SetMeasurementInterval.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SetMeasurementInterval ( I2C_parameters_t myI2Cparameters, uint16_t measurement_interval )
{
  ...
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( measurement_interval );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_GetMeasurementInterval    ( I2C_parameters_t , uint16_t* )
 * @details     It sets the measurement interval.
 *
 * @param[in]    myI2Cparameters:       I2C parameters.
 *
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetMeasurementInterval.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetMeasurementInterval ( I2C_parameters_t myI2Cparameters, uint16_t* measurement_interval )
{
  ...
  *measurement_interval  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *measurement_interval );
  ...
  if ( aux == I2C_SUCCESS )
  {
    ...
    {
      return   AMBIMATE_MS4_DATA_CORRUPTED;
    }
  }
  else
  {
...
/**
 * @brief       AMBIMATE_MS4_GetDataReadyStatus    ( I2C_parameters_t , AMBIMATE_MS4_get_ready_status_bit_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetDataReadyStatus.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetDataReadyStatus ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_get_ready_status_bit_t* status )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_GET_DATA_READY_STATUS >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_GET_DATA_READY_STATUS & 0xFF );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], 2U, I2C_STOP_BIT );
  ...
  *status  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *status );
...
/**
 * @brief       AMBIMATE_MS4_ReadRawMeasurement    ( I2C_parameters_t , AMBIMATE_MS4_raw_output_data_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_ReadRawMeasurement.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_ReadRawMeasurement ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_raw_output_data_t* raw_data )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_READ_MEASUREMENT >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_READ_MEASUREMENT & 0xFF );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], 2U, I2C_STOP_BIT );
  ...
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( aux_seed );
...
/**
 * @brief       AMBIMATE_MS4_ReadMeasurement    ( I2C_parameters_t , AMBIMATE_MS4_output_data_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_ReadMeasurement.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_ReadMeasurement ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_output_data_t* data )
{
  ...
  aux      =  AMBIMATE_MS4_ReadRawMeasurement ( myI2Cparameters, (AMBIMATE_MS4_raw_output_data_t*)&data->raw );
...
/**
 * @brief       AMBIMATE_MS4_SetContinuousASC    ( I2C_parameters_t , AMBIMATE_MS4_continuous_auto_selfcal_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SetContinuousASC.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SetContinuousASC ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_continuous_auto_selfcal_t asc )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_CONTINUOUS_AUTOMATIC_SELF_CALIBRATION >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_CONTINUOUS_AUTOMATIC_SELF_CALIBRATION & 0xFF );
  cmd[2]   =  (uint8_t)( asc >> 8U );
  cmd[3]   =  (uint8_t)( asc & 0xFF );
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( asc );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_GetContinuousASC    ( I2C_parameters_t , AMBIMATE_MS4_continuous_auto_selfcal_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetContinuousASC.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetContinuousASC ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_continuous_auto_selfcal_t* asc )
{
  ...
  *asc  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *asc );
...
/**
 * @brief       AMBIMATE_MS4_SetForcedRecalibrationValue    ( I2C_parameters_t , uint16_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SetForcedRecalibrationValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SetForcedRecalibrationValue ( I2C_parameters_t myI2Cparameters, uint16_t frc )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_SET_FORCED_RECALIBRATION >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_SET_FORCED_RECALIBRATION & 0xFF );
  cmd[2]   =  (uint8_t)( frc >> 8U );
  cmd[3]   =  (uint8_t)( frc & 0xFF );
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( frc );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_GetForcedRecalibrationValue    ( I2C_parameters_t , uint16_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetForcedRecalibrationValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetForcedRecalibrationValue ( I2C_parameters_t myI2Cparameters, uint16_t* frc )
{
  ...
  *frc  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *frc );
...
/**
 * @brief       AMBIMATE_MS4_SetTemperatureOffsetValue    ( I2C_parameters_t , uint16_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SetTemperatureOffsetValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SetTemperatureOffsetValue ( I2C_parameters_t myI2Cparameters, uint16_t temp_offset )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_SET_TEMPERATURE_OFFSET >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_SET_TEMPERATURE_OFFSET & 0xFF );
  cmd[2]   =  (uint8_t)( temp_offset >> 8U );
  cmd[3]   =  (uint8_t)( temp_offset & 0xFF );
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( temp_offset );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_GetTemperatureOffsetValue    ( I2C_parameters_t , uint16_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetTemperatureOffsetValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetTemperatureOffsetValue ( I2C_parameters_t myI2Cparameters, uint16_t* temp_offset )
{
  ...
  *temp_offset  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *temp_offset );
...
/**
 * @brief       AMBIMATE_MS4_SetAltitudeCompensationValue    ( I2C_parameters_t , uint16_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SetAltitudeCompensationValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SetAltitudeCompensationValue ( I2C_parameters_t myI2Cparameters, uint16_t alt_comp )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_SET_ALTITUDE_COMPENSATION >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_SET_ALTITUDE_COMPENSATION & 0xFF );
  cmd[2]   =  (uint8_t)( alt_comp >> 8U );
  cmd[3]   =  (uint8_t)( alt_comp & 0xFF );
  cmd[4]   =  AMBIMATE_MS4_CalculateI2C_CRC8 ( alt_comp );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_GetAltitudeCompensationValue    ( I2C_parameters_t , uint16_t* )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_GetAltitudeCompensationValue.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetAltitudeCompensationValue ( I2C_parameters_t myI2Cparameters, uint16_t* alt_comp )
{
  ...
  *alt_comp  |=   cmd[1];
  ...
  /* Check the CRC   */
  aux_crc    =  AMBIMATE_MS4_CalculateI2C_CRC8 ( *alt_comp );
...
/**
 * @brief       AMBIMATE_MS4_GetFirmwareVersion    ( I2C_parameters_t , AMBIMATE_MS4_fw_version_t* )
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_GetFirmwareVersion ( I2C_parameters_t myI2Cparameters, AMBIMATE_MS4_fw_version_t* fw )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_FIRMWARE_VERSION >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_FIRMWARE_VERSION & 0xFF );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], 2U, I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_SoftReset    ( I2C_parameters_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_SoftReset.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
AMBIMATE_MS4_status_t  AMBIMATE_MS4_SoftReset ( I2C_parameters_t myI2Cparameters )
{
  ...
  /* Write the register  */
  cmd[0]   =  (uint8_t)( AMBIMATE_MS4_SOFTRESET >> 8U );
  cmd[1]   =  (uint8_t)( AMBIMATE_MS4_SOFTRESET & 0xFF );
  aux      =  i2c_write ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ), I2C_STOP_BIT );
...
/**
 * @brief       AMBIMATE_MS4_CalculateI2C_CRC8    ( uint16_t )
 ...
 *
 *
 * @return      Status of AMBIMATE_MS4_CalculateI2C_CRC8.
 *
 * @author      Manuel Caballero
 * @date        27/January/2021
 * @version     27/January/2021    The ORIGIN
...
{
  uint8_t bit;                  
  uint8_t crc = AMBIMATE_MS4_CRC8_INITIALIZATION; 
  ...
  for(bit = 8U; bit > 0U; --bit)
  {
    if( crc & 0x80U )
    {
      crc = ( crc << 1U ) ^ AMBIMATE_MS4_CRC8_POLYNOMIAL;
    }
    else
    {
      crc = ( crc << 1U );

...
/**
 * @brief       DS1624_StartNewConvertTemperature  ( I2C_parameters_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_StartNewConvertTemperature.
 *
 *
 * @author      Manuel Caballero
...
{
    uint8_t      cmd[]  =   { DS1624_CONTROL_STATUS, 0 };
    uint32_t     aux    =   0;
    uint32_t     ii     =   0;
    ...
    while ( ( ( cmd[1] & STATUS_BUSY_MASK ) != STATUS_BUSY_NOBUSY ) && ( ii < DS1624_TIMEOUT ) );


    // if something went wrong, there will not be a new temperature conversion
    cmd[0]  =   DS1624_CONTROL;
    if ( ii < DS1624_TIMEOUT )
    {
        ...
        while ( ( ( cmd[1] & CONTROL_STATUS_CONVERT_TEMPERATURE_MASK ) != CONTROL_STATUS_CONVERT_TEMPERATURE_DISABLED ) && ( ii < DS1624_TIMEOUT ) );
    }
...
/**
 * @brief       DS1624_ReadRawAging ( I2C_parameters_t , DS1624_vector_data_t* )
 *
 ...
 *
 *
 * @return       Status of DS1624_ReadRawAging.
 *
 *
 * @author      Manuel Caballero
...
{
    uint8_t      cmd       =   DS1624_AGING_OFFSET;
    uint32_t     aux       =   0;
...
/**
 * @brief       DS1624_Status32kHzPin ( I2C_parameters_t , DS1624_status_enable_32khz_output_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_Status32kHzPin.
 *
 *
 * @author      Manuel Caballero
 * @date        18/December/2017
...
/**
 * @brief       DS1624_ClearAlarmFlag ( I2C_parameters_t , DS1624_status_alarm1_flag_t , DS1624_status_alarm2_flag_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_ClearAlarmFlag.
 *
 *
 * @author      Manuel Caballero
 * @date        18/December/2017
...
/**
 * @brief       DS1624_SetAlarm1 ( I2C_parameters_t , DS1624_alarm1_register_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetAlarm1.
 *
 *
 * @author      Manuel Caballero
 * @date        18/December/2017
...
/**
 * @brief       DS1624_SetAlarm2 ( I2C_parameters_t , DS1624_alarm2_register_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetAlarm2.
 *
 *
 * @author      Manuel Caballero
...
/**
 * @brief       DS1624_SetAlarmsInterrupt ( I2C_parameters_t , DS1624_control_status_alarm1_t , DS1624_control_status_alarm2_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetAlarmsInterrupt.
 *
 *
 * @author      Manuel Caballero
 * @date        19/December/2017
...
/**
 * @brief       DS1624_SetSquareWaveOutput ( I2C_parameters_t , DS1624_control_status_rate_select_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetSquareWaveOutput.
 *
 *
 * @author      Manuel Caballero
 * @date        19/December/2017
...
/**
 * @brief       DS1624_GetDate ( I2C_parameters_t , DS1624_vector_date_time_t* )
 *
 ...
 *
 *
 * @return       Status of DS1624_GetDate.
 *
 *
 * @author      Manuel Caballero
 * @date        19/December/2017
...
/**
 * @brief       DS1624_SetDate ( I2C_parameters_t , DS1624_vector_date_time_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetDate.
 *
 *
 * @author      Manuel Caballero
...
/**
 * @brief       DS1624_GetTime ( I2C_parameters_t , DS1624_vector_date_time_t* )
 *
 ...
 *
 *
 * @return       Status of DS1624_GetTime.
 *
 *
 * @author      Manuel Caballero
 * @date        19/December/2017
...
/**
 * @brief       DS1624_SetTime ( I2C_parameters_t , DS1624_vector_date_time_t )
 *
 ...
 *
 *
 * @return       Status of DS1624_SetTime.
 *
 *
 * @author      Manuel Caballero
 * @date        19/December/2017
...
/**
 * @brief       DS1624_GetControlStatusRegister ( I2C_parameters_t , DS1624_vector_data_t* )
 *
 ...
 *
 *
 * @return       Status of DS1624_GetControlStatusRegister.
 *
 *
 * @author      Manuel Caballero
 * @date        20/December/2017
...
{
    uint8_t      cmd     =   DS1624_CONTROL_STATUS;
    uint32_t     aux     =   0;

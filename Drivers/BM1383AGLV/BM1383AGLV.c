...
/**
 * @brief       BM1383AGLV_SetResolution ( I2C_parameters_t , BM1383AGLV_data_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetResolution ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetResolution ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myTempHumResolution )
{
  ...
  /* Read the register   */
  cmd   =   BM1383AGLV_AV_CONF;
  aux   =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux   =   i2c_read  ( myI2Cparameters, &cmd, 1U );

  /* Parse the data  */
  myTempHumResolution->temperatureResolution   =   (BM1383AGLV_av_config_avgt_t)( cmd & AV_CONF_AVGT_MASK );
  myTempHumResolution->humidityResolution      =   (BM1383AGLV_av_config_avgh_t)( cmd & AV_CONF_AVGH_MASK );
...
/**
 * @brief       BM1383AGLV_SetPowerDown ( I2C_parameters_t , BM1383AGLV_ctrl_reg1_pd_t )
 *
...
/**
 * @brief       BM1383AGLV_SetBlockDataUpdate ( I2C_parameters_t , BM1383AGLV_data_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetBlockDataUpdate.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetBlockDataUpdate ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetBlockDataUpdate.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetBlockDataUpdate ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myBDU )
{
  ...
  /* Read the register   */
  cmd   =   BM1383AGLV_CTRL_REG1;
  aux   =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux   =   i2c_read  ( myI2Cparameters, &cmd, 1U );

  /* Parse the data  */
  myBDU->bdu   =   (BM1383AGLV_ctrl_reg1_bdu_t)( cmd & CTRL_REG1_BDU_MASK );
...
/**
 * @brief       BM1383AGLV_SetOutputDataRate ( I2C_parameters_t , BM1383AGLV_data_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetOutputDataRate.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetOutputDataRate ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetOutputDataRate.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetOutputDataRate  ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myODR )
{
  ...
  /* Parse the data   */
  myODR->odr   =   (BM1383AGLV_ctrl_reg1_odr_t)( cmd & CTRL_REG1_ODR_MASK );
...
/**
 * @brief       BM1383AGLV_SetBoot ( I2C_parameters_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetBoot.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetBoot ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetBoot.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetBoot ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myBOOT )
{
  ...
  /* Read the register   */
  cmd   =   BM1383AGLV_CTRL_REG2;
  aux   =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux   =   i2c_read  ( myI2Cparameters, &cmd, 1U );

  /* Parse the data   */
  myBOOT->boot   =   (BM1383AGLV_ctrl_reg2_boot_t)( cmd & CTRL_REG2_BOOT_MASK );
...
/**
 * @brief       BM1383AGLV_SetHeater ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetHeater.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetHeater ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetHeater.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetHeater ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myHeater )
{
  ...
  /* Parse the data   */
  myHeater->heater   =   (BM1383AGLV_ctrl_reg2_heater_t)( cmd & CTRL_REG2_HEATER_MASK );
...
/**
 * @brief       BM1383AGLV_SetOneShot ( I2C_parameters_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetOneShot.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
/**
 * @brief       BM1383AGLV_GetOneShot ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetOneShot.
 *
 *
 * @author      Manuel Caballero
 * @date        23/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetOneShot ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myOneShot )
{
  ...
  /* Parse the data   */
  myOneShot->one_shot   =   (BM1383AGLV_ctrl_reg2_one_shot_t)( cmd & CTRL_REG2_ONE_SHOT_MASK );
...
/**
 * @brief       BM1383AGLV_SetDataReadyOuput ( I2C_parameters_t , BM1383AGLV_ctrl_reg3_drdy_h_l_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetDataReadyOuput.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
/**
 * @brief       BM1383AGLV_SetSelectionOnPin3 ( I2C_parameters_t , BM1383AGLV_ctrl_reg3_pp_od_t )
 *
...
/**
 * @brief       BM1383AGLV_SetDataReadyEnable ( I2C_parameters_t , BM1383AGLV_ctrl_reg3_drdy_en_t )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_SetDataReadyEnable.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
/**
 * @brief       BM1383AGLV_GetHumidityDataAvailable ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetHumidityDataAvailable.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetHumidityDataAvailable ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myHumidityFlag )
{
  ...
  /* Read the register   */
  cmd   =   BM1383AGLV_STATUS_REG;
  aux   =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux   =   i2c_read  ( myI2Cparameters, &cmd, 1U );

  /* Parse the data   */
  myHumidityFlag->h_da   =   (BM1383AGLV_status_reg_h_da_t)( cmd & STATUS_REGISTER_H_DA_MASK );
...
/**
 * @brief       BM1383AGLV_GetTemperatureDataAvailable ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetTemperatureDataAvailable.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetTemperatureDataAvailable ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myTemperatureFlag )
{
  ...
  /* Parse the data   */
  myTemperatureFlag->t_da   =   (BM1383AGLV_status_reg_t_da_t)( cmd & STATUS_REGISTER_T_DA_MASK );
...
/**
 * @brief       BM1383AGLV_GetRawHumidity ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetRawHumidity.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetRawHumidity ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myRawHumidity )
{
  ...
  /* Read the register   */
  cmd[0]   =   ( BM1383AGLV_HUMIDITY_OUT_L | 0x80 );                                        // Autoincrementing
  aux      =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
...
BM1383AGLV_status_t BM1383AGLV_GetRawTemperature ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myRawTemperature )
{
  ...
  /* Read the register   */
  cmd[0]   =   ( BM1383AGLV_TEMP_OUT_L | 0x80 );                                             // Autoincrementing
  aux      =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux      =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );
...
/**
 * @brief       BM1383AGLV_GetCalibrationCoefficients ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetCalibrationCoefficients.
 *
 *
 * @author      Manuel Caballero
 * @date        24/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetCalibrationCoefficients ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myCoeff )
{
  ...
  /* Read the register   */
  cmd[0]   =   ( BM1383AGLV_CALIB_0 | 0x80 );                                             // Autoincrementing
  aux      =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux      =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );
...
BM1383AGLV_status_t BM1383AGLV_GetTemperature ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myTemperature )
{
  ...
  /* Get temperature  */
  aux  =   BM1383AGLV_GetRawTemperature ( myI2Cparameters, &(*myTemperature) );
...
/**
 * @brief       BM1383AGLV_GetHumidity ( I2C_parameters_t , BM1383AGLV_data_t* )
 *
 ...
 *
 *
 * @return       Status of BM1383AGLV_GetHumidity.
 *
 *
 * @author      Manuel Caballero
 * @date        26/May/2019
...
BM1383AGLV_status_t BM1383AGLV_GetHumidity ( I2C_parameters_t myI2Cparameters, BM1383AGLV_data_t* myHumidity )
{
  ...
  /* Get humidity  */
  aux  =   BM1383AGLV_GetRawHumidity ( myI2Cparameters, &(*myHumidity) );

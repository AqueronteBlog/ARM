/**
 * @brief       WS2812.h
 * @details     [todo]WS2812 nano pressure sensor: 260-1260 hPa absolute digital output barometer.
 *              Header file.
 *
 *
 * @return      N/A
...
typedef enum
{
  WS2812_ADDRESS_0     =   0b1011100,       /*!<   I2C slave address byte, SDO/SA0 = GND        */
  WS2812_ADDRESS_1     =   0b1011101        /*!<   I2C slave address byte, SDO/SA0 = VDD        */
} WS2812_addresses_t;
...
typedef enum
{
  WS2812_INTERRUPT_CFG   =   0x0B,           /*!<  Interrupt registers                           */
  WS2812_THS_P_L         =   0x0C,           /*!<  Pressure threshold registers                  */
  WS2812_THS_P_H         =   0x0D,           /*!<  Pressure threshold registers                  */
  WS2812_WHO_AM_I        =   0x0F,           /*!<  Who am I register                             */
  WS2812_CTRL_REG1       =   0x10,           /*!<  Control registers                             */
  WS2812_CTRL_REG2       =   0x11,           /*!<  Control registers                             */
  WS2812_CTRL_REG3       =   0x12,           /*!<  Control registers                             */
  WS2812_FIFO_CTRL       =   0x14,           /*!<  FIFO configure registers                      */
  WS2812_REF_P_XL        =   0x15,           /*!<  Reference pressure registers                  */
  WS2812_REF_P_L         =   0x16,           /*!<  Reference pressure registers                  */
  WS2812_REF_P_H         =   0x17,           /*!<  Reference pressure registers                  */
  WS2812_RPDS_L          =   0x18,           /*!<  Pressure offset registers                     */
  WS2812_RPDS_H          =   0x18,           /*!<  Pressure offset registers                     */
  WS2812_RES_CONF        =   0x1A,           /*!<  Resolution register                           */
  WS2812_INT_SOURCE      =   0x25,           /*!<  Interrupt registers                           */
  WS2812_FIFO_STATUS     =   0x26,           /*!<  FIFO configure registers                      */
  WS2812_STATUS          =   0x27,           /*!<  Status register                               */
  WS2812_PRESS_OUT_XL    =   0x28,           /*!<  Pressure output register                      */
  WS2812_PRESS_OUT_L     =   0x29,           /*!<  Pressure output register                      */
  WS2812_PRESS_OUT_H     =   0x2A,           /*!<  Pressure output register                      */
  WS2812_TEMP_OUT_L      =   0x2B,           /*!<  Temperature output registers                  */
  WS2812_TEMP_OUT_H      =   0x2C,           /*!<  Temperature output registers                  */
  WS2812_LPFP_RES        =   0x33            /*!<  Filter reset register                         */
} WS2812_registers_t;
...
} WS2812_ctrl_reg2_stop_on_fth_t;
...
} WS2812_interrupt_cfg_autorifp_t;
...
} WS2812_interrupt_cfg_reset_arp_t;
...
} WS2812_interrupt_cfg_autozero_t;
...
} WS2812_interrupt_cfg_reset_az_t;
...
} WS2812_interrupt_cfg_diff_en_t;
...
} WS2812_int_source_boot_status_t;
...
typedef struct
{
  ...
  /* Configuration  */
  WS2812_ctrl_reg1_odr_t         odr;        /*!<  Output data rate selection        */
  WS2812_ctrl_reg1_bdu_t         bdu;        /*!<  Block data update                 */
  WS2812_ctrl_reg2_boot_t        boot;       /*!<  Reboot memory content flag        */
  WS2812_ctrl_reg2_fifo_en_t     fifo_en;    /*!<  FIFO enable                       */
  WS2812_ctrl_reg2_stop_on_fth_t stopOnFTH;  /*!<  FIFO watermark level use flag     */
  WS2812_ctrl_reg2_swreset_t     swreset;    /*!<  Software reset                    */
  WS2812_ctrl_reg2_one_shot_t    one_shot;   /*!<  One-shot                          */
  
  /* FIFO control  */
  WS2812_fifo_ctrl_f_mode_t      f_mode;     /*!<  FIFO mode selection               */  
...
/** It gets raw reference pressure.
  */
WS2812_status_t WS2812_GetReferencePressure     ( I2C_parameters_t myI2Cparameters, WS2812_data_t* myREF_P               );

/** It sets raw reference pressure.
  */
WS2812_status_t WS2812_SetReferencePressure     ( I2C_parameters_t myI2Cparameters, WS2812_data_t myREF_P                );

...
typedef enum
{
  ADS101X_ADDRESS_0     =   0b1011100,       /*!<   I2C slave address byte, SDO/SA0 = GND        */
  ADS101X_ADDRESS_1     =   0b1011101        /*!<   I2C slave address byte, SDO/SA0 = VDD        */
} ADS101X_addresses_t;
...
typedef enum
{
  ADS101X_INTERRUPT_CFG   =   0x0B,           /*!<  Interrupt registers                           */
  ADS101X_THS_P_L         =   0x0C,           /*!<  Pressure threshold registers                  */
  ADS101X_THS_P_H         =   0x0D,           /*!<  Pressure threshold registers                  */
  ADS101X_WHO_AM_I        =   0x0F,           /*!<  Who am I register                             */
  ADS101X_CTRL_REG1       =   0x10,           /*!<  Control registers                             */
  ADS101X_CTRL_REG2       =   0x11,           /*!<  Control registers                             */
  ADS101X_CTRL_REG3       =   0x12,           /*!<  Control registers                             */
  ADS101X_FIFO_CTRL       =   0x14,           /*!<  FIFO configure registers                      */
  ADS101X_REF_P_XL        =   0x15,           /*!<  Reference pressure registers                  */
  ADS101X_REF_P_L         =   0x16,           /*!<  Reference pressure registers                  */
  ADS101X_REF_P_H         =   0x17,           /*!<  Reference pressure registers                  */
  ADS101X_RPDS_L          =   0x18,           /*!<  Pressure offset registers                     */
  ADS101X_RPDS_H          =   0x18,           /*!<  Pressure offset registers                     */
  ADS101X_RES_CONF        =   0x1A,           /*!<  Resolution register                           */
  ADS101X_INT_SOURCE      =   0x25,           /*!<  Interrupt registers                           */
  ADS101X_FIFO_STATUS     =   0x26,           /*!<  FIFO configure registers                      */
  ADS101X_STATUS          =   0x27,           /*!<  Status register                               */
  ADS101X_PRESS_OUT_XL    =   0x28,           /*!<  Pressure output register                      */
  ADS101X_PRESS_OUT_L     =   0x29,           /*!<  Pressure output register                      */
  ADS101X_PRESS_OUT_H     =   0x2A,           /*!<  Pressure output register                      */
  ADS101X_TEMP_OUT_L      =   0x2B,           /*!<  Temperature output registers                  */
  ADS101X_TEMP_OUT_H      =   0x2C,           /*!<  Temperature output registers                  */
  ADS101X_LPFP_RES        =   0x33            /*!<  Filter reset register                         */
} ADS101X_registers_t;
...
} ADS101X_ctrl_reg2_stop_on_fth_t;
...
} ADS101X_ctrl_reg2_if_add_inc_t;
...
} ADS101X_interrupt_cfg_autorifp_t;
...
} ADS101X_interrupt_cfg_reset_arp_t;
...
} ADS101X_interrupt_cfg_autozero_t;
...
} ADS101X_interrupt_cfg_reset_az_t;
...
} ADS101X_interrupt_cfg_diff_en_t;
...
} ADS101X_int_source_boot_status_t;
...
} ADS101X_fifo_status_fth_fifo_t;
...
typedef struct
{
  ...
  /* Configuration  */
  ADS101X_ctrl_reg1_odr_t         odr;        /*!<  Output data rate selection        */
  ADS101X_ctrl_reg1_bdu_t         bdu;        /*!<  Block data update                 */
  ADS101X_ctrl_reg2_boot_t        boot;       /*!<  Reboot memory content flag        */
  ADS101X_ctrl_reg2_fifo_en_t     fifo_en;    /*!<  FIFO enable                       */
  ADS101X_ctrl_reg2_stop_on_fth_t stopOnFTH;  /*!<  FIFO watermark level use flag     */
  ADS101X_ctrl_reg2_swreset_t     swreset;    /*!<  Software reset                    */
  ADS101X_ctrl_reg2_one_shot_t    one_shot;   /*!<  One-shot                          */
  
  /* FIFO control  */
  ADS101X_fifo_ctrl_f_mode_t      f_mode;     /*!<  FIFO mode selection               */  
...
/** It gets raw reference pressure.
  */
ADS101X_status_t ADS101X_GetReferencePressure     ( I2C_parameters_t myI2Cparameters, ADS101X_data_t* myREF_P               );

/** It sets raw reference pressure.
  */
ADS101X_status_t ADS101X_SetReferencePressure     ( I2C_parameters_t myI2Cparameters, ADS101X_data_t myREF_P                );

...
LPS22HB_status_t LPS22HB_GetReferencePressure ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myREFL )
{
  ...
  /* Read the register   */
  cmd[0]  =   ( LPS22HB_REF_P_XL | 0x80 );                                              // Auto-increment enabled
...
/**
 * @brief       LPS22HB_SetTemperatureResolution ( I2C_parameters_t , LPS22HB_data_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetTemperatureResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        08/June/2019
...
/**
 * @brief       LPS22HB_GetTemperatureResolution ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetTemperatureResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        08/June/2019
...
LPS22HB_status_t LPS22HB_GetTemperatureResolution ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myAVGT )
{
  ...
  /* Read the register   */
  cmd  =   LPS22HB_RES_CONF;                                                     
  aux  =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux  =   i2c_read  ( myI2Cparameters, &cmd, 1U );
  
  /* Parse the data  */
  myAVGT->avgt   =   (LPS22HB_res_conf_avgt_t)( cmd & RES_CONF_AVGT_MASK );
...
/**
 * @brief       LPS22HB_SetPressureResolution ( I2C_parameters_t , LPS22HB_data_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetPressureResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        08/June/2019
...
/**
 * @brief       LPS22HB_GetPressureResolution ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetPressureResolution.
 *
 *
 * @author      Manuel Caballero
 * @date        08/June/2019
...
LPS22HB_status_t LPS22HB_GetPressureResolution ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myAVGP )
{
  ...
  /* Parse the data  */
  myAVGP->avgp   =   (LPS22HB_res_conf_avgp_t)( cmd & RES_CONF_AVGP_MASK );
...
/**
 * @brief       LPS22HB_SetResetAutozero ( I2C_parameters_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetResetAutozero.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_GetResetAutozero ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetResetAutozero.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
LPS22HB_status_t LPS22HB_GetResetAutozero ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myRESET_AZ )
{
  ...
  /* Parse the data  */
  myRESET_AZ->reset_az   =  (LPS22HB_ctrl_reg1_reset_az_t)( CTRL_REG1_RESET_AZ_MASK & cmd );
...
/**
 * @brief       LPS22HB_SetFIFOMeanDec ( I2C_parameters_t , LPS22HB_ctrl_reg2_fifo_mean_dec_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetFIFOMeanDec.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_SetAutozero ( I2C_parameters_t , LPS22HB_data_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetAutozero.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_GetAutozero ( I2C_parameters_t , LPS22HB_data_t* )
 *
 * @details     It gets the software reset flag value.
 *
 * @param[in]    myI2Cparameters: I2C parameters.
 ...
 *
 *
 * @return       Status of LPS22HB_GetAutozero.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
LPS22HB_status_t LPS22HB_GetAutozero ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myAUTOZERO )
{
  ...
  /* Parse the data  */
  myAUTOZERO->autozero   =  (LPS22HB_ctrl_reg2_autozero_t)( CTRL_REG2_AUTOZERO_MASK & cmd );
...
/**
 * @brief       LPS22HB_SetOneShot ( I2C_parameters_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetOneShot.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_SetInterruptActiveMode ( I2C_parameters_t , LPS22HB_ctrl_reg3_int_h_l_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetInterruptActiveMode.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_SetDrainSelectionMode ( I2C_parameters_t , LPS22HB_ctrl_reg3_pp_od_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetDrainSelectionMode.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_SetDataSignalOnPin ( I2C_parameters_t , LPS22HB_ctrl_reg3_int_s2_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetDataSignalOnPin.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_SetINT_DRDY_Behaviour ( I2C_parameters_t , LPS22HB_data_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetINT_DRDY_Behaviour.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_GetINT_DRDY_Behaviour ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetINT_DRDY_Behaviour.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
LPS22HB_status_t LPS22HB_GetINT_DRDY_Behaviour ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myIntConfig )
{
  ...
  /* Read the register   */
  cmd  =   LPS22HB_CTRL_REG4;                                                     
  aux  =   i2c_write ( myI2Cparameters, &cmd, 1U, I2C_NO_STOP_BIT );
  aux  =   i2c_read  ( myI2Cparameters, &cmd, 1U );
  
  /* Parse the data  */
  myIntConfig->f_empty   =  (LPS22HB_ctrl_reg4_f_empty_t)( CTRL_REG4_F_EMPTY_MASK & cmd );
  myIntConfig->f_fth     =  (LPS22HB_ctrl_reg4_f_fth_t)( CTRL_REG4_F_FTH_MASK & cmd );
  myIntConfig->f_ovr     =  (LPS22HB_ctrl_reg4_f_ovr_t)( CTRL_REG4_F_OVR_MASK & cmd );
  myIntConfig->drdy      =  (LPS22HB_ctrl_reg4_drdy_t)( CTRL_REG4_DRDY_MASK & cmd );
...
/**
 * @brief       LPS22HB_SetInterruptConfiguration ( I2C_parameters_t , LPS22HB_data_t )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetInterruptConfiguration.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
/**
 * @brief       LPS22HB_GetInterruptConfiguration ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetInterruptConfiguration.
 *
 *
 * @author      Manuel Caballero
 * @date        09/June/2019
...
LPS22HB_status_t LPS22HB_GetInterruptConfiguration ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myIntConfig )
{
  ...
  /* Parse the data  */
  myIntConfig->lir   =  (LPS22HB_interrupt_cfg_lir_t)( INTERRUPT_CFG_LIR_MASK & cmd );
  myIntConfig->pl_e  =  (LPS22HB_interrupt_cfg_pl_e_t)( INTERRUPT_CFG_PL_E_MASK & cmd );
  myIntConfig->ph_e  =  (LPS22HB_interrupt_cfg_ph_e_t)( INTERRUPT_CFG_PH_E_MASK & cmd );
...
LPS22HB_status_t LPS22HB_GetRawPressure ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myRawPressure )
{
  ...
  /* Read the register   */
  cmd[0]  =   ( LPS22HB_PRESS_OUT_XL | 0x80 );                                         // Force auto-increment
  aux     =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux     =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );
...
LPS22HB_status_t LPS22HB_GetRawTemperature ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myRawTemperature )
{
  ...
  /* Read the register   */
  cmd[0]  =   ( LPS22HB_TEMP_OUT_L | 0x80 );                                         // Force auto-increment
  aux     =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux     =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );
...
LPS22HB_status_t LPS22HB_GetFIFO_Threshold ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myFIFOthreshold )
{
  ...
  /* Parse the data  */
  myFIFOthreshold->wtm_point   =  (LPS22HB_fifo_ctrl_wtm_point_t)( FIFO_CTRL_WTM_POINT_MASK & cmd );
...
/**
 * @brief       LPS22HB_GetFIFO_ThresholdValue ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_GetFIFO_ThresholdValue.
 *
 *
 * @author      Manuel Caballero
 * @date        10/June/2019
...
LPS22HB_status_t LPS22HB_GetFIFO_ThresholdValue ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myFIFOthresholdValue )
{
  ...
  /* Read the register   */
  cmd[0]  =   ( LPS22HB_THS_P_L | 0x80 );                                   // Force auto-increment
  aux     =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux     =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );
...
/**
 * @brief       LPS22HB_SetFIFO_ThresholdValue ( I2C_parameters_t , LPS22HB_data_t* )
 *
 ...
 *
 *
 * @return       Status of LPS22HB_SetFIFO_ThresholdValue.
 *
 *
 * @author      Manuel Caballero
 * @date        10/June/2019
...
LPS22HB_status_t LPS22HB_GetPressureOffset ( I2C_parameters_t myI2Cparameters, LPS22HB_data_t* myPressureOffset )
{
  ...
  /* Read the register   */
  cmd[0]  =   ( LPS22HB_RPDS_L | 0x80 );                                   // Force auto-increment
  aux     =   i2c_write ( myI2Cparameters, &cmd[0], 1U, I2C_NO_STOP_BIT );
  aux     =   i2c_read  ( myI2Cparameters, &cmd[0], sizeof( cmd )/sizeof( cmd[0] ) );

...
} BMA456_ctrl_reg2_stop_on_fth_t;
...
} BMA456_interrupt_cfg_autorifp_t;
...
} BMA456_interrupt_cfg_reset_arp_t;
...
} BMA456_interrupt_cfg_autozero_t;
...
} BMA456_interrupt_cfg_reset_az_t;
...
} BMA456_interrupt_cfg_diff_en_t;
...
} BMA456_int_source_boot_status_t;
...
/** It gets raw reference pressure.
  */
BMA456_status_t BMA456_GetReferencePressure     ( I2C_parameters_t myI2Cparameters, BMA456_data_t* myREF_P               );

/** It sets raw reference pressure.
  */
BMA456_status_t BMA456_SetReferencePressure     ( I2C_parameters_t myI2Cparameters, BMA456_data_t myREF_P                );

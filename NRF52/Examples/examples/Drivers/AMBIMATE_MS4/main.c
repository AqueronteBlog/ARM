/**
 * @brief       main.c
 * @details     This example shows how to work with the external device: AMBIMATE_MS4. Every 4 seconds, a new
 ...
 * @pre         This firmware was tested on the nrf52-DK with Segger Embedded Studio v5.50 ( SDK 14.2.0 ).
